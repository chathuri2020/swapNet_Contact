<header class="navbar sticky-top bg-light flex-md-nowrap p-0 shadow" data-bs-theme="light">
    ...
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="{{ route('admin.index') }}">
    <img src="{{ asset('images/swapnet.png') }}" alt="SwapNet Logo" style="height: 40px;">
    SwapNet
    </a>
